...
import {IV3RateStrategyFactory} from '../../v3-config-engine/IV3RateStrategyFactory.sol';
    ...
    returns (IEngine.ListingWithCustomImpl[] memory)
  {
    ...
    listingsCustom[0] = IEngine.ListingWithCustomImpl(
      IEngine.Listing({
        ...
        rateStrategyParams: IV3RateStrategyFactory(AaveV3Ethereum.RATES_FACTORY).getStrategyDataOfAsset(
