...
contract ProtocolV4TestBase is SnapshotV4, Scenarios, TokenizationScenarios, GatewayScenarios {
  ...
  function _testGiverPositionManager(
    ...
    IGiverPositionManager giverPositionManager = AaveV4EthereumPositionManagers.GIVER_POSITION_MANAGER;
    address oracleAddr = spoke.ORACLE();
  ...
  function _testTakerPositionManager(
    ...
    ITakerPositionManager takerPositionManager = AaveV4EthereumPositionManagers.TAKER_POSITION_MANAGER;
  ...
  function _testConfigPositionManager(
    ...
    IConfigPositionManager configPositionManager = AaveV4EthereumPositionManagers.CONFIG_POSITION_MANAGER;
    address oracleAddr = spoke.ORACLE();
