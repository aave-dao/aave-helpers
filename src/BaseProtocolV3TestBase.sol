...
abstract contract BaseProtocolV3TestBase is RawProtocolV3TestBase, SeatbeltUtils, CommonTestBase, DiffUtils {
  ...
  function _getBytecode(address contractAddress) internal virtual view returns (bytes memory);
}